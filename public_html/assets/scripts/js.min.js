...
function throttle(t,e,n){var a,o;return e=e||(e=250),function(){var i=n||this,l=+new Date,s=arguments;a&&l<a+e?(clearTimeout(o),o=setTimeout(function(){a=l,t.apply(i,s)},e)):(a=l,t.apply(i,s))}}var lifeboat=lifeboat||{};lifeboat.invoke=function(){for(var t,e,n=document.querySelectorAll("[data-js]"),a=0,o=n.length;a<o;a++)t=n[a],e=t.getAttribute("data-js"),this[e]&&this[e](t)},lifeboat.headerTransition=function(t){$(window).on("scroll",throttle(function(){$(this).scrollTop()>50?$(t).addClass("active"):$(t).removeClass("active")},250))},lifeboat.navTrigger=function(t){t.onclick=function(){document.body.classList.toggle("menu-open")}},lifeboat.navMenu=function(t){window.matchMedia("(max-width:768px)").matches&&$(".sub-menu",$(t)).click(function(){$("ul",$(this)).css({display:"block"})})},lifeboat.ajaxForm=function(t){t.onsubmit=function(e){var n=$(t),a=n.serialize();e.preventDefault(),n.addClass("loading"),$.ajax({url:$('[name="action"]',n),method:"POST",data:a,success:function(t,e,a){n.removeClass("loading").fadeOut(),n.next(".info-message").fadeIn()},error:function(t,e,a){n.removeClass("loading")}})}},lifeboat.invoke();